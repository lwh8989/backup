...
!(function(l, e) {
  ...
  function e(e) {
    ...
    if (!t.data.outer) {
      var o = { border: 'none', 'box-sizing': 'content-box', height: '200px', margin: '0', padding: '0', width: '200px' }
    ...
    return t.data.outer.scrollLeft(1e3).scrollTop(1e3), { height: Math.ceil(t.data.outer.offset().top - t.data.inner.offset().top || 0), width: Math.ceil(t.data.outer.offset().left - t.data.inner.offset().left || 0) }
  }
  function o() {
    var l = e(!0)
  ...
  var r = !1,
    t = { data: { index: 0, name: 'scrollbar' }, macosx: /mac/i.test(navigator.platform), mobile: /android|webos|iphone|ipad|ipod|blackberry/i.test(navigator.userAgent), overlay: null, scroll: null, scrolls: [], webkit: /webkit/i.test(navigator.userAgent) && !/edge\/\d+/i.test(navigator.userAgent) }
  ...
  var i = { autoScrollSize: !0, autoUpdate: !0, debug: !1, disableBodyScroll: !1, duration: 200, ignoreMobile: !1, ignoreOverlay: !1, scrollStep: 30, showArrows: !1, stepScrolling: !0, scrollx: null, scrolly: null, onDestroy: null, onInit: null, onScroll: null, onUpdate: null },
    n = function(s) {
      t.scroll ||
        ((t.overlay = o()),
        (t.scroll = e()),
  ...
  n.prototype = {
    ...
    init: function(e) {
      ...
      if (d) i.css({ height: 'auto', 'margin-bottom': -1 * t.scroll.height + 'px', 'margin-right': -1 * t.scroll.width + 'px', 'max-height': '' })
      else {
        if (
          ...
          i.addClass('scroll-content').css({ height: 'auto', 'margin-bottom': -1 * t.scroll.height + 'px', 'margin-right': -1 * t.scroll.width + 'px', 'max-height': '' }),
          r.on('scroll' + n, function(e) {
            l.isFunction(c.onScroll) && c.onScroll.call(o, { maxScroll: a.y.maxScrollOffset, scroll: r.scrollTop(), size: a.y.size, visible: a.y.visible }, { maxScroll: a.x.maxScrollOffset, scroll: r.scrollLeft(), size: a.x.size, visible: a.x.visible }),
      ...
      l.each(a, function(e, t) {
        ...
        t.scroll ||
          ...
          t.scroll.find('.scroll-arrow, .scroll-element_track').on('mousedown' + n, function(s) {
            ...
            d = 1
            var n = { eventOffset: s['x' === e ? 'pageX' : 'pageY'], maxScrollValue: t.size - t.visible - t.offset, scrollbarOffset: t.scroll.bar.offset()['x' === e ? 'left' : 'top'], scrollbarSize: t.scroll.bar['x' === e ? 'outerWidth' : 'outerHeight']() },
              a = 0,
              v = 0
            return (
              l(this).hasClass('scroll-arrow')
                ? ((d = l(this).hasClass('scroll-arrow_more') ? 1 : -1), (p = c.scrollStep * d), (f = d > 0 ? n.maxScrollValue : 0))
                : ((d = n.eventOffset > n.scrollbarOffset + n.scrollbarSize ? 1 : n.eventOffset < n.scrollbarOffset ? -1 : 0), (p = Math.round(0.75 * t.visible) * d), (f = n.eventOffset - n.scrollbarOffset - (c.stepScrolling ? (1 == d ? n.scrollbarSize : 0) : Math.round(n.scrollbarSize / 2))), (f = r[h]() + f / t.kx)),
              (o.scrollTo = o.scrollTo || {}),
        ...
        l.each(a, function(e, o) {
          l.extend(o, 'x' == e ? { offset: parseInt(r.css('left'), 10) || 0, size: r.prop('scrollWidth'), visible: d.width() } : { offset: parseInt(r.css('top'), 10) || 0, size: r.prop('scrollHeight'), visible: d.height() })
        }),
    ...
    _getScroll: function(e) {
      ...
      return o[e] && (e = o[e]), e || (e = o.simple), (e = 'string' == typeof e ? l(e).appendTo(this.wrapper) : l(e)), l.extend(e, { bar: e.find('.scroll-bar'), size: e.find('.scroll-element_size'), track: e.find('.scroll-element_track') }), e
    },
    ...
    _updateScroll: function(e, o) {
      var s = this.container,
        ...
        h = o.visible + c
      ;(o.isVisible = d - h > 1),
        o.isVisible ? (o.scroll.addClass(i), n.scroll.addClass(i), r.addClass(i)) : (o.scroll.removeClass(i), n.scroll.removeClass(i), r.removeClass(i)),
        'y' === e && (s.is('textarea') || h > d ? r.css({ height: h + t.scroll.height + 'px', 'max-height': 'none' }) : r.css({ 'max-height': h + t.scroll.height + 'px' })),
        (o.size != s.prop('scrollWidth') || n.size != s.prop('scrollHeight') || o.visible != a.width() || n.visible != a.height() || o.offset != (parseInt(s.css('left'), 10) || 0) || n.offset != (parseInt(s.css('top'), 10) || 0)) &&
          (l.extend(this.scrollx, { offset: parseInt(s.css('left'), 10) || 0, size: s.prop('scrollWidth'), visible: a.width() }), l.extend(this.scrolly, { offset: parseInt(s.css('top'), 10) || 0, size: this.container.prop('scrollHeight'), visible: a.height() }), this._updateScroll('x' === e ? 'y' : 'x', n))
    }
  }
  var c = n
    ...
    return function(o) {
      ...
      for (s = 0; s < t.scrolls.length; s++)
        (c = t.scrolls[s]),
          ...
          (h = c.scrollx),
          (p = c.scrolly),
          (o || (n.autoUpdate && d && d.is(':visible') && (i.prop('scrollWidth') != h.size || i.prop('scrollHeight') != p.size || d.width() != h.visible || d.height() != p.visible))) &&
            (c.init(), n.debug && (window.console && console.log({ scrollHeight: i.prop('scrollHeight') + ':' + c.scrolly.size, scrollWidth: i.prop('scrollWidth') + ':' + c.scrollx.size, visibleHeight: d.height() + ':' + c.scrolly.visible, visibleWidth: d.width() + ':' + c.scrollx.visible }, !0), e++))
