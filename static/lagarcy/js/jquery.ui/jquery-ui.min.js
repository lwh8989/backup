...
;(function(e) {
  ...
  function o() {
    e.datepicker._isDisabledDatepicker(v.inline ? v.dpDiv.parent()[0] : v.input[0]) ||
      (e(this)
  ...
  e(document).mouseup(function() {
    ...
    e.widget('ui.menu', {
          ...
          this._on({
            ...
            'click .ui-menu-item': function(t) {
              ...
              !this.mouseHandled &&
                ...
                (this.select(t), t.isPropagationStopped() || (this.mouseHandled = !0), i.has('.ui-menu').length ? this.expand(t) : !this.element.is(':focus') && e(this.document[0].activeElement).closest('.ui-menu').length && (this.element.trigger('focus', [!0]), this.active && 1 === this.active.parents('.ui-menu').length && clearTimeout(this.timer)))
            },
      ...
      _scrollIntoView: function(t) {
        var i, s, n, a, o, r
        this._hasScroll() &&
          ((i = parseFloat(e.css(this.activeMenu[0], 'borderTopWidth')) || 0), (s = parseFloat(e.css(this.activeMenu[0], 'paddingTop')) || 0), (n = t.offset().top - this.activeMenu.offset().top - i - s), (a = this.activeMenu.scrollTop()), (o = this.activeMenu.height()), (r = t.outerHeight()), 0 > n ? this.activeMenu.scrollTop(a + n) : n + r > o && this.activeMenu.scrollTop(a + n - o + r))
      },
      blur: function(e, t) {
    ...
    e.widget('ui.autocomplete', {
      ...
      _create: function() {
        ...
        ;(this.isMultiLine = a ? !0 : o ? !1 : this.element.prop('isContentEditable')),
          ...
          (this.liveRegion = e('<span>', { role: 'status', 'aria-live': 'assertive', 'aria-relevant': 'additions' })
      ...
      __response: function(t) {
        ...
        this._superApply(arguments),
          this.options.disabled ||
            this.cancelSearch ||
            ((i = t && t.length ? this.options.messages.results(t.length) : this.options.messages.noResults),
            this.liveRegion.children().hide(),
            e('<div>')
              .text(i)
              .appendTo(this.liveRegion))
  ...
  e.extend(n.prototype, {
    ...
    _dialogDatepicker: function(t, i, s, n, a) {
      var o,
        ...
        c = this._dialogInst
      return (
        c || ((this.uuid += 1), (o = 'dp' + this.uuid), (this._dialogInput = e("<input type='text' id='" + o + "' style='position: absolute; top: -100px; width: 0px;'/>")), this._dialogInput.keydown(this._doKeyDown), e('body').append(this._dialogInput), (c = this._dialogInst = this._newInst(this._dialogInput, !1)), (c.settings = {}), e.data(this._dialogInput[0], 'datepicker', c)),
        r(c.settings, n || {}),
    ...
    _generateHTML: function(e) {
      ...
      for (
        ...
        for (k = '', this.maxRows = 4, T = 0; K[1] > T; T++) {
          ...
          for (
            M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === w ? (Y ? a : s) : '') + (/all|right/.test(S) && 0 === w ? (Y ? s : a) : '') + this._generateMonthYearHeader(e, Z, et, X, $, w > 0 || T > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead>" + '<tr>',
          ...
          for (
            M += C + '</tr></thead><tbody>', A = this._getDaysInMonth(et, Z), et === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, A)), P = (this._getFirstDayOfMonth(et, Z) - u + 7) % 7, I = Math.ceil((P + A) / 7), H = Q ? (this.maxRows > I ? this.maxRows : I) : I, this.maxRows = H, z = this._daylightSavingAdjust(new Date(et, Z, 1 - P)), F = 0;
            H > F;
            F++
          ) {
            for (M += '<tr>', E = d ? "<td class='ui-datepicker-week-col'>" + this._get(e, 'calculateWeek')(z) + '</td>' : '', x = 0; 7 > x; x++)
              (O = g ? g.apply(e.input ? e.input[0] : null, [z]) : [!0, '']),
                ...
                (E +=
                  ...
                  (j && !v ? '' : ' ' + O[1] + (z.getTime() === G.getTime() ? ' ' + this._currentClass : '') + (z.getTime() === R.getTime() ? ' ui-datepicker-today' : '')) +
                  "'" +
                  ((j && !v) || !O[2] ? '' : " title='" + O[2].replace(/'/g, '&#39;') + "'") +
                  (W ? '' : " data-handler='selectDay' data-event='click' data-month='" + z.getMonth() + "' data-year='" + z.getFullYear() + "'") +
                  '>' +
                  (j && !v ? '&#xa0;' : W ? "<span class='ui-state-default'>" + z.getDate() + '</span>' : "<a class='ui-state-default" + (z.getTime() === R.getTime() ? ' ui-state-highlight' : '') + (z.getTime() === G.getTime() ? ' ui-state-active' : '') + (j ? ' ui-priority-secondary' : '') + "' href='#'>" + z.getDate() + '</a>') +
                  '</td>'),
    ...
    e.widget('ui.draggable', e.ui.mouse, {
      ...
      _mouseStop: function(t) {
        ...
        return (
          ...
          ('invalid' === this.options.revert && !s) || ('valid' === this.options.revert && s) || this.options.revert === !0 || (e.isFunction(this.options.revert) && this.options.revert.call(this.element, s))
      ...
      _getParentOffset: function() {
        var t = this.offsetParent.offset(),
          i = this.document[0]
        return (
          'absolute' === this.cssPosition && this.scrollParent[0] !== i && e.contains(this.scrollParent[0], this.offsetParent[0]) && ((t.left += this.scrollParent.scrollLeft()), (t.top += this.scrollParent.scrollTop())),
        ...
        return (
          ...
          n.containment
            ? 'window' === n.containment
              ...
              ? ((this.containment = [0, 0, e(a).width() - this.helperProportions.width - this.margins.left, (e(a).height() || a.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top]), void 0)
      ...
      _generatePosition: function(e, t) {
        ...
        return (
          ...
          t &&
            ...
            o.grid &&
              ((n = o.grid[1] ? this.originalPageY + Math.round((l - this.originalPageY) / o.grid[1]) * o.grid[1] : this.originalPageY),
    ...
    e.ui.plugin.add('draggable', 'scroll', {
      ...
      drag: function(t, i, s) {
        var n = s.options,
          ...
          r = s.document[0]
        o !== r && 'HTML' !== o.tagName
          ? ((n.axis && 'x' === n.axis) || (s.overflowOffset.top + o.offsetHeight - t.pageY < n.scrollSensitivity ? (o.scrollTop = a = o.scrollTop + n.scrollSpeed) : t.pageY - s.overflowOffset.top < n.scrollSensitivity && (o.scrollTop = a = o.scrollTop - n.scrollSpeed)),
            (n.axis && 'y' === n.axis) || (s.overflowOffset.left + o.offsetWidth - t.pageX < n.scrollSensitivity ? (o.scrollLeft = a = o.scrollLeft + n.scrollSpeed) : t.pageX - s.overflowOffset.left < n.scrollSensitivity && (o.scrollLeft = a = o.scrollLeft - n.scrollSpeed)))
          : ((n.axis && 'x' === n.axis) || (t.pageY - e(r).scrollTop() < n.scrollSensitivity ? (a = e(r).scrollTop(e(r).scrollTop() - n.scrollSpeed)) : e(window).height() - (t.pageY - e(r).scrollTop()) < n.scrollSensitivity && (a = e(r).scrollTop(e(r).scrollTop() + n.scrollSpeed))),
      ...
      drag: function(t, i, s) {
        ...
        for (c = s.snapElements.length - 1; c >= 0; c--)
          (h = s.snapElements[c].left - s.margins.left),
            ...
            h - m > v || g > l + m || u - m > b || y > d + m || !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item)
              ? (s.snapElements[c].snapping && s.options.snap.release && s.options.snap.release.call(s.element, t, e.extend(s._uiHash(), { snapItem: s.snapElements[c].item })), (s.snapElements[c].snapping = !1))
              : ('inner' !== f.snapMode &&
                  ((n = m >= Math.abs(u - b)),
                  (a = m >= Math.abs(d - y)),
                  (o = m >= Math.abs(h - v)),
                  ...
                  a && (i.position.top = s._convertPositionTo('relative', { top: d, left: 0 }).top),
                  o && (i.position.left = s._convertPositionTo('relative', { top: 0, left: h - s.helperProportions.width }).left),
                ...
                'outer' !== f.snapMode &&
                  ...
                  a && (i.position.top = s._convertPositionTo('relative', { top: d - s.helperProportions.height, left: 0 }).top),
                  o && (i.position.left = s._convertPositionTo('relative', { top: 0, left: h }).left),
                  r && (i.position.left = s._convertPositionTo('relative', { top: 0, left: l - s.helperProportions.width }).left)),
                !s.snapElements[c].snapping && (n || a || o || r || p) && s.options.snap.snap && s.options.snap.snap.call(s.element, t, e.extend(s._uiHash(), { snapItem: s.snapElements[c].item })),
    ...
    e.widget('ui.resizable', e.ui.mouse, {
      ...
      _create: function() {
        ...
        if (
          ...
          e.extend(this, { _aspectRatio: !!r.aspectRatio, aspectRatio: r.aspectRatio, originalElement: this.element, _proportionallyResizeElements: [], _helper: r.helper || r.ghost || r.animate ? r.helper || 'ui-resizable-helper' : null }),
          ...
          (this.handles = r.handles || (e('.ui-resizable-handle', this.element).length ? { n: '.ui-resizable-n', e: '.ui-resizable-e', s: '.ui-resizable-s', w: '.ui-resizable-w', se: '.ui-resizable-se', sw: '.ui-resizable-sw', ne: '.ui-resizable-ne', nw: '.ui-resizable-nw' } : 'e,s,se')),
          (this._handles = e()),
          ...
          for (i in this.handles)
            this.handles[i].constructor === String
              ? (this.handles[i] = this.element
                  ...
                  .first()
                  .show())
              : (this.handles[i].jquery || this.handles[i].nodeType) && ((this.handles[i] = e(this.handles[i])), this._on(this.handles[i], { mousedown: o._mouseDown })),
        ...
        return (
          ...
          h
            ? ((i = h.apply(this, [t, o, r])),
              ...
              e.isEmptyObject(s) || (this._updatePrevProperties(), this._trigger('resize', t, this.ui()), this._applyChanges()),
              !1)
            : !1
        )
      },
      ...
      _updateVirtualBoundaries: function(e) {
        var t,
          ...
          a,
          o = this.options
        ;(a = { minWidth: this._isNumber(o.minWidth) ? o.minWidth : 0, maxWidth: this._isNumber(o.maxWidth) ? o.maxWidth : 1 / 0, minHeight: this._isNumber(o.minHeight) ? o.minHeight : 0, maxHeight: this._isNumber(o.maxHeight) ? o.maxHeight : 1 / 0 }),
      ...
      _respectSize: function(e) {
        var t = this._vBoundaries,
          ...
          u = /nw|ne|n/.test(i)
        return (
          a && (e.width = t.minWidth), o && (e.height = t.minHeight), s && (e.width = t.maxWidth), n && (e.height = t.maxHeight), a && l && (e.left = r - t.minWidth), s && l && (e.left = r - t.maxWidth), o && u && (e.top = h - t.minHeight), n && u && (e.top = h - t.maxHeight), e.width || e.height || e.left || !e.top ? e.width || e.height || e.top || !e.left || (e.left = null) : (e.top = null), e
        )
      },
      ...
      _renderProxy: function() {
        ...
        ;(this.elementOffset = t.offset()),
          this._helper
            ? ((this.helper = this.helper || e("<div style='overflow:hidden;'></div>")), this.helper.addClass(this._helper).css({ width: this.element.outerWidth() - 1, height: this.element.outerHeight() - 1, position: 'absolute', left: this.elementOffset.left + 'px', top: this.elementOffset.top + 'px', zIndex: ++i.zIndex }), this.helper.appendTo('body').disableSelection())
      ...
      start: function() {
        ...
        c &&
          ...
          /document/.test(d) || d === document
            ? ((h.containerOffset = { left: 0, top: 0 }), (h.containerPosition = { left: 0, top: 0 }), (h.parentData = { element: e(document), left: 0, top: 0, width: e(document).width(), height: e(document).height() || document.body.parentNode.scrollHeight }))
            : ((t = e(c)),
              (i = []),
              ...
              (h.containerSize = { height: t.innerHeight() - i[3], width: t.innerWidth() - i[1] }),
              (s = h.containerOffset),
              (n = h.containerSize.height),
              (a = h.containerSize.width),
              (o = h._hasScroll(c, 'left') ? c.scrollWidth : a),
              (r = h._hasScroll(c) ? c.scrollHeight : n),
              (h.parentData = { element: c, left: s.left, top: s.top, width: o, height: r })))
      },
      resize: function(t) {
        var i,
          s,
      ...
      resize: function() {
        ...
        ;(s.grid = h),
          ...
          /^(se|s|e)$/.test(r)
            ...
            : /^(ne)$/.test(r)
            ? ((i.size.width = p), (i.size.height = f), (i.position.top = o.top - c))
            : /^(sw)$/.test(r)
            ? ((i.size.width = p), (i.size.height = f), (i.position.left = o.left - d))
            : ((0 >= f - u || 0 >= p - l) && (t = i._getPaddingPlusBorderDimensions(this)), f - u > 0 ? ((i.size.height = f), (i.position.top = o.top - c)) : ((f = u - t.height), (i.size.height = f), (i.position.top = o.top + a.height - f)), p - l > 0 ? ((i.size.width = p), (i.position.left = o.left - d)) : ((p = l - t.width), (i.size.width = p), (i.position.left = o.left + a.width - p)))
      }
    }),
    e.ui.resizable,
    e.widget('ui.dialog', {
      ...
      _setOption: function(e, t) {
        ...
        'dialogClass' === e && n.removeClass(this.options.dialogClass).addClass(t),
          'disabled' !== e &&
            ...
            'resizable' === e && ((s = n.is(':data(ui-resizable)')), s && !t && n.resizable('destroy'), s && 'string' == typeof t && n.resizable('option', 'handles', t), s || t === !1 || this._makeResizable()),
  ...
  ;(e.effects = { effect: {} }),
      ...
      ;(p.style.cssText = 'background-color:rgba(1,1,1,.5)'),
        ...
        (u.hsla.to = function(e) {
          ...
          var t,
            ...
            u = r + h,
            d = 0.5 * u
          return (t = h === r ? 0 : s === r ? (60 * (n - a)) / l + 360 : n === r ? (60 * (a - s)) / l + 120 : (60 * (s - n)) / l + 240), (i = 0 === l ? 0 : 0.5 >= d ? l / u : l / (2 - u)), [Math.round(t) % 360, i, d, null == o ? 1 : o]
        }),
    ...
    (e.effects.effect.bounce = function(t, i) {
      ...
      l && ((n = { opacity: 0 }), (n[v] = (y ? '-=' : '+=') + c), o.animate(n, m, g)),
        o.queue(function() {
        ...
        for (h = g.top + a * y, u = a - (d - 1) / 2, o = 0; c > o; o++)
          (r = g.left + o * v),
            ...
            p
              ...
              .appendTo('body')
              .wrap('<div></div>')
              .css({ position: 'absolute', visibility: 'visible', left: -o * v, top: -a * y })
              .parent()
              .addClass('ui-effects-explode')
              .css({ position: 'absolute', overflow: 'hidden', width: v, height: y, left: r + (m ? l * v : 0), top: h + (m ? u * y : 0), opacity: m ? 0 : 1 })
    ...
    (e.effects.effect.size = function(t, i) {
      ...
      'show' === p && o.show(),
        ...
        (a = { from: { y: o.from.height / s.height, x: o.from.width / s.width }, to: { y: o.to.height / s.height, x: o.to.width / s.width } }),
        ...
        ('content' === m || 'both' === m) &&
          ...
          o.find('*[width]').each(function() {
            ...
            f && e.effects.save(i, l),
              (i.from = { height: s.height * a.from.y, width: s.width * a.from.x, outerHeight: s.outerHeight * a.from.y, outerWidth: s.outerWidth * a.from.x }),
              (i.to = { height: s.height * a.to.y, width: s.width * a.to.x, outerHeight: s.height * a.to.y, outerWidth: s.width * a.to.x }),
    ...
    (e.effects.effect.scale = function(t, i) {
      ...
      ;(n.effect = 'size'),
        ...
        (n.to = { height: l.height * u.y, width: l.width * u.x, outerHeight: l.outerHeight * u.y, outerWidth: l.outerWidth * u.x }),
    ...
    (e.effects.effect.transfer = function(t, i) {
      var s = e(this),
        ...
        c = e("<div class='ui-effects-transfer'></div>")
          ...
          .css({ top: d.top - r, left: d.left - h, height: s.innerHeight(), width: s.innerWidth(), position: a ? 'fixed' : 'absolute' })
    ...
    e.widget('ui.progressbar', {
      ...
      _refreshValue: function() {
        ...
        this.valueDiv
          ...
          this.indeterminate ? (this.element.removeAttr('aria-valuenow'), this.overlayDiv || (this.overlayDiv = e("<div class='ui-progressbar-overlay'></div>").appendTo(this.valueDiv))) : (this.element.attr({ 'aria-valuemax': this.options.max, 'aria-valuenow': t }), this.overlayDiv && (this.overlayDiv.remove(), (this.overlayDiv = null))),
          ...
          return (
            ...
            this.selectees.each(function() {
              ...
              i &&
                ...
                l
                  ? (i.selected && (i.$element.removeClass('ui-selected'), (i.selected = !1)), i.unselecting && (i.$element.removeClass('ui-unselecting'), (i.unselecting = !1)), i.selecting || (i.$element.addClass('ui-selecting'), (i.selecting = !0), s._trigger('selecting', t, { selecting: i.element })))
                  : (i.selecting &&
                      ((t.metaKey || t.ctrlKey) && i.startselected ? (i.$element.removeClass('ui-selecting'), (i.selecting = !1), i.$element.addClass('ui-selected'), (i.selected = !0)) : (i.$element.removeClass('ui-selecting'), (i.selecting = !1), i.startselected && (i.$element.addClass('ui-unselecting'), (i.unselecting = !0)), s._trigger('unselecting', t, { unselecting: i.element }))),
                    i.selected && (t.metaKey || t.ctrlKey || i.startselected || (i.$element.removeClass('ui-selected'), (i.selected = !1), i.$element.addClass('ui-unselecting'), (i.unselecting = !0), s._trigger('unselecting', t, { unselecting: i.element })))))
            }),
            !1
          )
        }
    ...
    e.widget('ui.selectmenu', {
      ...
      _drawButton: function() {
        ...
        ;(this.label = e("label[for='" + this.ids.element + "']").attr('for', this.ids.button)),
          ...
          this.element.hide(),
          (this.button = e('<span>', { class: 'ui-selectmenu-button ui-widget ui-state-default ui-corner-all', tabindex: this.options.disabled ? -1 : 0, id: this.ids.button, role: 'combobox', 'aria-expanded': 'false', 'aria-autocomplete': 'list', 'aria-owns': this.ids.menu, 'aria-haspopup': 'true' }).insertAfter(this.element)),
    ...
    e.widget('ui.slider', e.ui.mouse, {
            ...
            r === !1
              ...
              : ((this._mouseSliding = !0),
                ...
                (l = !e(t.target)
                  ...
                  .addBack()
                  .is('.ui-slider-handle')),
                (this._clickOffset = l ? { left: 0, top: 0 } : { left: t.pageX - h.left - a.width() / 2, top: t.pageY - h.top - a.height() / 2 - (parseInt(a.css('borderTopWidth'), 10) || 0) - (parseInt(a.css('borderBottomWidth'), 10) || 0) + (parseInt(a.css('marginTop'), 10) || 0) }),
      ...
      _normValueFromMouse: function(e) {
        var t, i, s, n, a
        return (
          'horizontal' === this.orientation ? ((t = this.elementSize.width), (i = e.x - this.elementOffset.left - (this._clickOffset ? this._clickOffset.left : 0))) : ((t = this.elementSize.height), (i = e.y - this.elementOffset.top - (this._clickOffset ? this._clickOffset.top : 0))),
          (s = i / t),
          s > 1 && (s = 1),
          0 > s && (s = 0),
      ...
      _slide: function(e, t, i) {
        ...
        this.options.values && this.options.values.length
          ? ((s = this.values(t ? 0 : 1)), 2 === this.options.values.length && this.options.range === !0 && ((0 === t && i > s) || (1 === t && s > i)) && (i = s), i !== this.values(t) && ((n = this.values()), (n[t] = i), (a = this._trigger('slide', e, { handle: this.handles[t], value: i, values: n })), (s = this.values(t ? 0 : 1)), a !== !1 && this.values(t, i)))
      ...
      _setOption: function(t, i) {
        var s,
          n = 0
        switch (
          ('range' === t && this.options.range === !0 && ('min' === i ? ((this.options.value = this._values(0)), (this.options.values = null)) : 'max' === i && ((this.options.value = this._values(this.options.values.length - 1)), (this.options.values = null))),
    ...
    e.widget('ui.sortable', e.ui.mouse, {
      ...
      _mouseStart: function(t, i, s) {
        ...
        if (
          ...
          o.cursor && 'auto' !== o.cursor && ((a = this.document.find('body')), (this.storedCursor = a.css('cursor')), a.css('cursor', o.cursor), (this.storedStylesheet = e('<style>*{ cursor: ' + o.cursor + ' !important; }</style>').appendTo(a))),
          ...
          this.position = this._generatePosition(t),
            ...
            this.options.scroll &&
              (this.scrollParent[0] !== this.document[0] && 'HTML' !== this.scrollParent[0].tagName
                ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - t.pageY < o.scrollSensitivity ? (this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop + o.scrollSpeed) : t.pageY - this.overflowOffset.top < o.scrollSensitivity && (this.scrollParent[0].scrollTop = r = this.scrollParent[0].scrollTop - o.scrollSpeed),
                  this.overflowOffset.left + this.scrollParent[0].offsetWidth - t.pageX < o.scrollSensitivity ? (this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft + o.scrollSpeed) : t.pageX - this.overflowOffset.left < o.scrollSensitivity && (this.scrollParent[0].scrollLeft = r = this.scrollParent[0].scrollLeft - o.scrollSpeed))
                : (t.pageY - this.document.scrollTop() < o.scrollSensitivity ? (r = this.document.scrollTop(this.document.scrollTop() - o.scrollSpeed)) : this.window.height() - (t.pageY - this.document.scrollTop()) < o.scrollSensitivity && (r = this.document.scrollTop(this.document.scrollTop() + o.scrollSpeed)),
      ...
      _intersectsWith: function(e) {
        var t = this.positionAbs.left,
          ...
          p = d && c
        return 'pointer' === this.options.tolerance || this.options.forcePointerForContainers || ('pointer' !== this.options.tolerance && this.helperProportions[this.floating ? 'width' : 'height'] > e[this.floating ? 'width' : 'height'])
          ? p
      ...
      _createHelper: function(t) {
        ...
        return (
          ...
          s[0] === this.currentItem[0] && (this._storedCSS = { width: this.currentItem[0].style.width, height: this.currentItem[0].style.height, position: this.currentItem.css('position'), top: this.currentItem.css('top'), left: this.currentItem.css('left') }),
      ...
      _getParentOffset: function() {
        ...
        var t = this.offsetParent.offset()
        return (
          'absolute' === this.cssPosition && this.scrollParent[0] !== this.document[0] && e.contains(this.scrollParent[0], this.offsetParent[0]) && ((t.left += this.scrollParent.scrollLeft()), (t.top += this.scrollParent.scrollTop())),
          (this.offsetParent[0] === this.document[0].body || (this.offsetParent[0].tagName && 'html' === this.offsetParent[0].tagName.toLowerCase() && e.ui.ie)) && (t = { top: 0, left: 0 }),
          { top: t.top + (parseInt(this.offsetParent.css('borderTopWidth'), 10) || 0), left: t.left + (parseInt(this.offsetParent.css('borderLeftWidth'), 10) || 0) }
        )
      },
      _getRelativeOffset: function() {
      ...
      _generatePosition: function(t) {
        ...
        return (
          ...
          { top: o - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + ('fixed' === this.cssPosition ? -this.scrollParent.scrollTop() : h ? 0 : r.scrollTop()), left: a - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + ('fixed' === this.cssPosition ? -this.scrollParent.scrollLeft() : h ? 0 : r.scrollLeft()) }
        )
      },
      ...
      _processTabs: function() {
        ...
        ;(this.tablist = this._getList()
          ...
          this.anchors.each(function(i, s) {
            ...
            t._isLocal(s) ? ((n = s.hash), (o = n.substring(1)), (a = t.element.find(t._sanitizeSelector(n)))) : ((o = h.attr('aria-controls') || e({}).uniqueId()[0].id), (n = '#' + o), (a = t.element.find(n)), a.length || ((a = t._createPanel(o)), a.insertAfter(t.panels[i - 1] || t.tablist)), a.attr('aria-live', 'polite')),
      ...
      _eventHandler: function(t) {
        ...
        t.preventDefault(),
          a.hasClass('ui-state-disabled') ||
            ...
            ((i.active = r ? !1 : this.tabs.index(a)), (this.active = o ? e() : a), this.xhr && this.xhr.abort(), l.length || h.length || e.error('jQuery UI Tabs: Mismatching fragment identifier.'), h.length && this.load(this.tabs.index(a), t), this._toggle(t, u))
      },
        ...
        if (s) {
          ...
          i.is('[title]') && (t && 'mouseover' === t.type ? i.attr('title', '') : i.removeAttr('title')),
            ...
            e('<div>')
              .html(h)
              .appendTo(this.liveRegion),
            this.options.track && t && /^mouse/.test(t.type) ? (this._on(this.document, { mousemove: n }), n(t)) : o.position(e.extend({ of: i }, this.options.position)),
            o.hide(),
