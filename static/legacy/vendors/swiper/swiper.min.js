  ...
  var d = {
    updateSize: function() {
      ...
      ;(e = void 0 !== a.params.width ? a.params.width : i[0].clientWidth),
        ...
        (0 === e && a.isHorizontal()) || (0 === t && a.isVertical()) || ((e = e - parseInt(i.css('padding-left'), 10) - parseInt(i.css('padding-right'), 10)), (t = t - parseInt(i.css('padding-top'), 10) - parseInt(i.css('padding-bottom'), 10)), ee.extend(a, { width: e, height: t, size: a.isHorizontal() ? e : t }))
    },
        ...
        for (var E, S = t.slidesPerColumn, C = x / S, M = Math.floor(d / t.slidesPerColumn), z = 0; z < d; z += 1) {
          ...
          if ('none' !== P.css('display')) {
            ...
            l[z] && (l[z].swiperSlideSize = T),
              u.push(T),
              t.centeredSlides ? ((b = b + T / 2 + w / 2 + g), 0 === w && 0 !== z && (b = b - i / 2 - g), 0 === z && (b = b - i / 2 - g), Math.abs(b) < 0.001 && (b = 0), t.roundLengths && (b = Math.floor(b)), y % t.slidesPerGroup == 0 && p.push(b), c.push(b)) : (t.roundLengths && (b = Math.floor(b)), y % t.slidesPerGroup == 0 && p.push(b), c.push(b), (b = b + T + g)),
              (e.virtualSize += T + g),
              (w = T),
              (y += 1)
          }
                    ...
                    if (!(t.params.threshold && Math.sqrt(Math.pow(p, 2) + Math.pow(c, 2)) < t.params.threshold))
                      if (
                        ...
                        i.followFinger &&
                          ...
                          i.freeMode && (0 === a.velocities.length && a.velocities.push({ position: s[t.isHorizontal() ? 'startX' : 'startY'], time: a.touchStartTime }), a.velocities.push({ position: s[t.isHorizontal() ? 'currentX' : 'currentY'], time: ee.now() })),
  ...
  var A = {
    ...
    X = {
      ...
      onGestureStart: function(e) {
        ...
        ;(s.$slideEl && s.$slideEl.length) || ((s.$slideEl = L(e.target).closest('.swiper-slide')), 0 === s.$slideEl.length && (s.$slideEl = t.slides.eq(t.activeIndex)), (s.$imageEl = s.$slideEl.find('img, svg, canvas')), (s.$imageWrapEl = s.$imageEl.parent('.' + a.containerClass)), (s.maxRatio = s.$imageWrapEl.attr('data-swiper-zoom') || a.maxRatio), 0 !== s.$imageWrapEl.length)
      ...
      onGestureChange: function(e) {
        ...
        i.$imageEl &&
          0 !== i.$imageEl.length &&
          ((a.scale = te.gestures ? e.scale * a.currentScale : (i.scaleMove / i.scaleStart) * a.currentScale), a.scale > i.maxRatio && (a.scale = i.maxRatio - 1 + Math.pow(a.scale - i.maxRatio + 1, 0.5)), a.scale < t.minRatio && (a.scale = t.minRatio + 1 - Math.pow(t.minRatio - a.scale + 1, 0.5)), i.$imageEl.transform('translate3d(0,0,0) scale(' + a.scale + ')'))
      },
